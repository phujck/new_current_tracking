...
fit = np.polyfit([4, 6, 8, 10, 12, 14], dimensionalitysite, deg=1)
linearfit = np.array([4, 6, 8, 10, 12, 14])
plt.plot([4, 6, 8, 10, 12, 14], fit[0] * linearfit + fit[1])
plt.plot([4, 6, 8, 10, 12, 14], dimensionalitysite)
